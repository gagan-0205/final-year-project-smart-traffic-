...
GLfloat position_c1 = -3.5f; // for car 1
...
GLfloat speed_c3 = 0.01f;
 ...
 GLfloat position_c4 = 0.9;// for car 4
 GLfloat speed_c4 = 0.02f;

GLfloat position_c5 = -3.5f; // for car 1
GLfloat speed_c5 = 0.01f;

GLfloat position_c6 = 1.6f; // for car 6
GLfloat speed_c6 = 0.01f;

GLfloat position_c7 = -1.3f; // for car 7
GLfloat speed_c7 = 0.01f;

GLfloat position_c8 = 1.3f; // for car 8
GLfloat speed_c8 = 0.01f;

GLfloat position_c10 = 1.6f; // for car 6
GLfloat speed_c10 = 0.01f;

GLfloat position_c11 = -1.3f; // for car 7
GLfloat speed_c11 = 0.01f;

GLfloat position_c12 = 1.3f; // for car 8
GLfloat speed_c12 = 0.01f;

GLfloat position_c13 = -4.5f; // for car 8
GLfloat speed_c13 = 0.01f;

GLfloat position_c14 = 1.3f; // for car 8
GLfloat speed_c14 = 0.01f;
...
void car1() {
    glPushMatrix();
	glTranslatef(position_c1+x+2.5+y, 0.0f, 0.0f);
 ...
 void car5 ()
{
    ...
    glPushMatrix();
	glTranslatef(position_c1+x+0.25 , 0.5f+x+0.25, 1.0f);
...
void car6() // Modified truck function to ensure identical appearance to the first truck
{
    glPushMatrix();

    // Adjusting position to match the other truck and avoid overlap
    glTranslatef(position_c6+x+1.0+ y+0.5, 0.5f+x, 0.5f+x+1.2); // Adjust based on your animation/position logic

    // Keeping the truck size identical to the first truck (avoid scaling that causes differences)
    glScalef(1.2f,1.0f  ,1.0f); // No scaling distortion
    glRotatef(180, 0.0f, 1.0f, 0.0f); // No rotation needed (since we want both to face the same way)
...
void car7()
 {
	...
	glTranslatef(0.9+x+0.73, position_c7+x+0.4, 0.0f);
	glRotatef(90, 0.0f, 0.0f, 1.0f);
   glBegin(GL_POLYGON);
    glColor3ub(255, 255, 255); // White body for the ambulance
    glVertex2f(-0.2f, 0.25f);
    glVertex2f(0.07f, 0.25f);
    glVertex2f(0.15f, 0.23f);
    glVertex2f(0.17f, 0.2f);
    ...
    // Ambulance Roof
    glBegin(GL_POLYGON);
    glColor3ub(255, 255, 255); // White roof
    glVertex2f(0.03f, 0.09f);
    glVertex2f(0.03f, 0.21f);
    glVertex2f(-0.15f, 0.21f);
    glVertex2f(-0.15f, 0.09f);
    ...
    // Headlights
    glBegin(GL_POLYGON);
    glColor3ub(242, 242, 242); // Light color
    glVertex2f(0.15f, 0.23f);
    glVertex2f(0.17f, 0.2f);
    glVertex2f(0.14f, 0.2f);
    glVertex2f(0.14f, 0.23f);
    ...
    // Ambulance Red and Blue Lights on Top
    glBegin(GL_POLYGON);
    glColor3ub(255, 0, 0); // Red light on the roof
    ...
    glBegin(GL_POLYGON);
    glColor3ub(0, 0, 255); // Blue light on the roof
    ...
    // Lines for detailing (Optional)
    glBegin(GL_LINES);
    glColor3ub(255, 0, 0); // Red detailing line
    glVertex2f(-0.22f, 0.14f);
    glVertex2f(0.17f, 0.14f);
    glEnd();

    // Outline for the ambulance (Optional, add more for detailing)
    glBegin(GL_LINES);
...
void car8()
{
	...
	glTranslatef(0.9 + x + 0.73, position_c8+x + y + 0.3, 0.0f);
	glRotatef(270 ,0.0f, 0.0f, 1.0f);
    glBegin(GL_POLYGON); // body
        glColor3ub(51, 102, 255);
        glVertex2f(-0.13f, 0.25f);
...
void car10() // Modified truck function to ensure identical appearance to the first truck
{
    glPushMatrix();
     glTranslatef(position_c6+x+1.9+ y+0.5, 0.5f+x, 0.5f+x+1.0);

    // Keeping the truck size identical to the first truck (avoid scaling that causes differences)
    glScalef(1.0f,1.0f  ,1.0f); // No scaling distortion
    glRotatef(180, 0.0f, 1.0f, 0.0f); // No rotation needed (since we want both to face the same way)
...
void car11()
 {
	...
	glTranslatef(0.9+x+0.73, position_c7+x+1.5+y-2.45, 0.0f);
	glRotatef(90, 0.0f, 0.0f, 1.0f);
    glBegin(GL_POLYGON); // body
        glColor3ub(255, 255, 255);
        glVertex2f(-0.13f, 0.25f);
...
void car12()
{
	...
	glTranslatef(0.9 + x + 0.73, position_c8+x + y + 0.7, 0.0f);
	glRotatef(270 ,0.0f, 0.0f, 1.0f);
    glBegin(GL_POLYGON); // body
        glColor3ub(51, 102, 255);
        glVertex2f(-0.13f, 0.25f);
...
void car13 ()
{
    ...
    glPushMatrix();
	glTranslatef(position_c5+x+1.0 , 0.5f+x+0.25, 1.0f);
...
void car14()
{
	...
	glTranslatef(0.9 + x + 0.73, position_c8+x + y + 1.2, 0.0f);
	glRotatef(270 ,0.0f, 0.0f, 1.0f);
     // Truck Body (yellow)
  glBegin(GL_POLYGON); // body
        glColor3ub(255, 204, 0);
...
void day() {
    ...
    car4();
    car5();
    car6(); // With headlights OFF // Now car6() is properly declared and called
    car7();
    car8();
    car10();
    car11();
...
void update_car5(int value) {
    if(cnt == 0){
        speed_c5 = 0.01f;
        if(position_c5 > 2.7)
            position_c5 = -2.7f;

        position_c5 += speed_c5;
    }
	...
	glutPostRedisplay();
	glutTimerFunc(10, update_car5, 0);
}

void update_car6(int value) {
    if(cnt == 0) {
        speed_c6 = 0.01f;
        if(position_c6 <-5.0)
            position_c6 = 2.5f;

        position_c6 -= speed_c6;
    }
    else {
        if(position_c6 < 2.5) {
            speed_c6 = 0.0f;
	...
	glutPostRedisplay();
	glutTimerFunc(10, update_car6, 0);
}

void update_car7(int value) {
    if(cnt == 0) {
        if(position_c7 > -0.9) {  // Stops car when reaching a certain point
            speed_c7 = 0.0f;
            position_c7 = -0.9;  // Keeps car in place
        }
        position_c7 += speed_c7;  // No change in position if speed is 0
    }

    else {
        speed_c7 = 0.01f;  // Sets speed for forward movement
        if(position_c7 > 1.7)   // Resets car position after reaching boundary
            position_c7 = -1.7f; // Moves car horizontally from left to right

        position_c7 += speed_c7; // Update position on a straight path
    }

    glutPostRedisplay();
    glutTimerFunc(10, update_car7, 0);  // Updates car at a fixed interval
}

void update_car8(int value) {
    if(cnt == 0) {
        if(position_c8 < 0.9) {
            speed_c8 = 0.0f;
            position_c8 = 0.9;
        }
        position_c8 -= speed_c8;
    }
	...
	glutPostRedisplay();
	glutTimerFunc(10, update_car8, 0);
}

void update_car10(int value) {
    if(cnt == 0) {
        speed_c10 = 0.01f;
        if(position_c10 <-6.0f)
            position_c10 = 3.0f;

        position_c10 -= speed_c10;
    }
    else {
        if(position_c10 < 2.5f) {
            speed_c10 = 0.01f;
            position_c10 = 1.8;
        }
        position_c10 -= speed_c10;
	...
	glutPostRedisplay();
	glutTimerFunc(10, update_car10, 0);
}
void update_car11(int value) {
    if(cnt == 0) {
        if(position_c11 > -0.9) {  // Stops car when reaching a certain point
            speed_c11 = 0.0f;
            position_c11 = -0.9;  // Keeps car in place
        }
        position_c11 += speed_c11;  // No change in position if speed is 0
    }

    else {
        speed_c11 = 0.01f;  // Sets speed for forward movement
        if(position_c11 > 1.7)   // Resets car position after reaching boundary
            position_c11 = -1.7f; // Moves car horizontally from left to right

        position_c11 += speed_c11; // Update position on a straight path
    }

    glutPostRedisplay();
    glutTimerFunc(10, update_car11, 0);  // Updates car at a fixed interval
}
void update_car12(int value) {
    if(cnt == 0) {
        if(position_c12 < 0.9) {
            speed_c12 = 0.0f;
            position_c12 = 0.9;
        }
        position_c12 -= speed_c12;
    }
	...
	glutPostRedisplay();
	glutTimerFunc(10, update_car12, 0);
}
void update_car13(int value) {
    if(cnt == 0){
        speed_c13 = 0.01f;
        if(position_c13 > 2.7)
            position_c13 = -2.7f;

        position_c13 += speed_c13;
    }
	...
	glutPostRedisplay();
	glutTimerFunc(10, update_car13, 0);
}
void update_car14(int value) {
    if(cnt == 0) {
        if(position_c14 < 0.9) {
            speed_c14 = 0.0f;
            position_c14 = 0.9;
        }
        position_c14 -= speed_c14;
    }
	...
	glutPostRedisplay();
	glutTimerFunc(10, update_car14, 0);
}
...
// Main function: GLUT runs as a console application starting at main()
 int main(int argc, char** argv) {
    ...
    glutTimerFunc(10, update_car5, 0);
    glutTimerFunc(10, update_car6, 0);
    glutTimerFunc(10, update_car7, 0);
    glutTimerFunc(10, update_car8, 0);
   glutTimerFunc(10, update_car10, 0);
   glutTimerFunc(10, update_car11, 0);
   glutTimerFunc(10, update_car12, 0);
   glutTimerFunc(10, update_car13, 0);
    glutTimerFunc(100, update_rain, 0);
